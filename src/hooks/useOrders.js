...
export async function createOrder({ cart, customer, shippingAddress, shipping, total, paymentMethod, notes, discountCode, discountAmount }) {
  const { data: order, error: orderError } = await supabase
    ...
    .insert({
      ...
      subtotal:         total - shipping + (discountAmount || 0),
      shipping,
      total,

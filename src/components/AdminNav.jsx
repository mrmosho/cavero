...
export default function AdminNav() {
  ...
  return (
    <nav style={{ background: 'var(--dark)', borderBottom: '1px solid rgba(232,228,216,0.08)', padding: '0 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 56, position: 'sticky', top: 0, zIndex: 100, overflowX: 'auto' }}>
      <div className="admin-nav-inner" style={{ display: 'flex', alignItems: 'center', gap: 32, minWidth: 0 }}>
        ...
        <div className="admin-nav-links" style={{ display: 'flex', gap: 4, marginLeft: 8 }}>
      ...
      <div className="admin-nav-right" style={{ display: 'flex', alignItems: 'center', gap: 20, flexShrink: 0 }}>
        {user && (
          <span className="admin-nav-email" style={{ fontSize: '0.72rem', color: 'var(--stone)' }}>{user.email}</span>
        )}

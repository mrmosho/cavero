export const PRODUCTS = [
  ...
  { slug:'duo-statue',    name:'The Duo — Couple Piece',  price:550,  category:'gifts',    label:'Couples & Gifts',        badge:'custom', available:true, customisable:true,  sort_order:3, description:'Two intertwined figures, custom-made for you. Choose body types, hair, skin tones. A piece that tells your story.', details:'Made to order with full customisation. Production time: 7–10 days. Height: 24cm.' },
  ...
  { slug:'luna-light',    name:'The Luna Light',          price:420,  category:'lighting', label:'Candle Holders',     badge:'new',    available:true, customisable:false, sort_order:6, description:'A half-sphere ambient lamp that diffuses warm light evenly through a matte plaster shell. USB-C powered.', details:'Matte plaster shell, warm white LED 2700K. USB-C powered. Diameter: 18cm.' },
  ...
  { slug:'column-candle', name:'Column Candle Holder',    price:180,  category:'lighting', label:'Candle Holders',        badge:null,     available:true, customisable:false, sort_order:8, description:'A slender tapered column for pillar candles. Cast in matte concrete with a bronze-dusted base.', details:'Matte concrete finish, bronze-dusted base. Height: 22cm.' },
]

// Shipping
export const FREE_SHIPPING_THRESHOLD = 1000   // EGP
export const FLAT_SHIPPING_RATE      = 80     // EGP — replace with Bosta API call later
export const PRODUCTION_DAYS        = '5–7'  // shown to customers

// Egypt governorates for address form
...
// Order statuses — single source of truth for display labels
...
// Payment methods — expand when Paymob is wired
export const PAYMENT_METHODS = [
  ...
  // { id: 'wallet', label: 'Mobile wallet',         description: 'Vodafone Cash, Orange Cash, Etisalat Cash' },
]

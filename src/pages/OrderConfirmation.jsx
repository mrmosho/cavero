        ...
        <div className="container" style={{ maxWidth:680 }}>
          <div style={{ textAlign:'center', marginBottom:56 }}>
            ...
            <p style={{ fontSize:'1rem', lineHeight:1.8, color:'rgba(45,43,52,0.72)', maxWidth:480, margin:'0 auto' }}>
              Your order has been received. We will be in touch within 24 hours to confirm payment and start production.
            </p>
          </div>
          ...
          <div style={{ padding:'28px 32px', borderRadius:'var(--r)', border:'1px solid rgba(45,43,52,0.1)', marginBottom:40 }}>
            ...
            {[
              ['Within 24 hours', "We will contact you via WhatsApp or email to confirm payment and any personalisation details."],

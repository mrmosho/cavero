    ...
    <>
      ...
      <section className="hero">
          ...
          <svg viewBox="0 0 1440 900" style={{ width: '100%', height: '100%' }} preserveAspectRatio="xMidYMid slice">
            <defs>
              <radialGradient id="hg1" cx="30%" cy="40%" r="60%">
                <stop offset="0%"   stopColor="#3D3844"/>
                <stop offset="100%" stopColor="#1E1C22"/>
              </radialGradient>
              <radialGradient id="hg2" cx="75%" cy="65%" r="45%">
                <stop offset="0%"   stopColor="#4A4452" stopOpacity={0.8}/>
                <stop offset="100%" stopColor="#1E1C22" stopOpacity={0}/>
              </radialGradient>
            </defs>
            ...
            <circle cx="1240" cy="700" r="460" fill="none" stroke="rgba(168,149,111,0.04)" strokeWidth="1"/>
        ...
        <div className="hero__content">
          <p className="t-label hero__eyebrow" style={{ color: 'rgba(168,149,111,0.9)', marginBottom: 24, animation: 'fadeIn .8s ease both' }}>
            Cairo, Egypt · Est. 2025
          </p>
          <h1 className="t-hero hero__title" style={{ color: 'var(--cream)', marginBottom: 24, animation: 'fadeSlideUp .9s .1s var(--ease-out) both' }}>
            Objects<br /><em>that belong.</em>
          </h1>
          <p className="hero__sub" style={{ animation: 'fadeSlideUp .9s .2s var(--ease-out) both' }}>
            Precision-crafted home objects. Made to order — designed for your space, finished by hand, built to last.
          </p>
        ...
        <div className="container">
          ...
          <div className="text-center mt-64 reveal">
            <Link to="/shop" className="btn btn-outline btn-lg">
              View all {PRODUCTS.length} objects
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="statement__inner reveal">
            ...
            <p className="statement__text">
              Most home objects are made for <em>nobody</em> in particular. Cavero pieces are made
              to order — designed for your space, finished by hand, and built to belong exactly
              where you put them.
            </p>
      ...
      <section className="section" style={{ background: 'var(--cream)' }}>
        <div className="container">
          <div className="section-header section-header--center reveal" style={{ marginBottom: 48 }}>
            ...
            <p className="t-body" style={{ maxWidth: 480, margin: '16px auto 0' }}>
              Every Cavero piece arrives gift-ready. For anniversaries, new homes, and the moments that matter.
            </p>
          </div>
          <div className="grid-2 reveal d1" style={{ gap: 16 }}>
            <Link to="/gifting" className="gift-card">
              ...
              <div className="gift-card__content">
                <p className="gift-card__title">For couples</p>
                <p className="gift-card__sub">Custom statues · Personalised pieces</p>
                <span className="gift-card__link">Explore →</span>
              </div>
            </Link>

            <div style={{ display: 'grid', gridTemplateRows: '1fr 1fr', gap: 16 }}>
              {[['For the home', 'Vases · Planters · Wall art', 'linear-gradient(135deg,#4A4452,#3D3844)'],
                ['For the desk', 'Stands · Holders · Trays',   'linear-gradient(135deg,#2D2B34,#3D3844)']
              ].map(([title, sub, bg]) => (
                <Link key={title} to="/gifting" className="gift-card">
                  ...
                  <div className="gift-card__content">
                    ...
                    <p className="gift-card__sub">{sub}</p>
                    <span className="gift-card__link">Explore →</span>
                  </div>
                </Link>
              ))}
        ...
        <div className="container">
          ...
          <div className="process__steps reveal d1">
            {[
              ...
              <div className="process__step" key={num}>
      ...
      <section className="section" style={{ background: 'var(--cream)' }}>
        <div className="container">
          <div className="section-header reveal">
            <div>
              <p className="t-label section-header__eyebrow">What people say</p>
              <h2 className="t-h2">Real orders. Real reactions.</h2>
            </div>
          </div>
      ...
      {/* ── INSTAGRAM ── */}
      <section className="section-sm" style={{ background: 'var(--light)', padding: '60px 0' }}>
        <div className="container">
          <div className="text-center mb-32 reveal">
            <p className="t-label" style={{ marginBottom: 8 }}>Follow along</p>
            <a href="https://instagram.com/cavero.studio" target="_blank" rel="noreferrer"
              style={{ fontFamily: 'var(--font-display)', fontSize: '1.6rem', fontWeight: 300, color: 'var(--charcoal)' }}>
              @cavero.studio
            </a>
          </div>
          <div className="insta-grid reveal d1">
            {[['◇', 'var(--light)'], ['○', 'linear-gradient(135deg,#DDD9CE,#C8C4BA)'], ['△', 'linear-gradient(135deg,#C8C4BA,#DDD9CE)'],
              ...
              <div className="insta-item" key={i}>
                <div className="insta-item__placeholder" style={{ background: bg }}>{sym}</div>
                <div className="insta-item__overlay">View →</div>
              </div>
            ))}
          </div>

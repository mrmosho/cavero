    ...
    <>
      ...
      <section style={{ background: 'var(--light)', padding: '60px 0' }}>
        <div className="container">
          ...
          <div className="text-center mt-32 reveal"><a href="https://instagram.com/caveroegy" target="_blank" rel="noreferrer" className="btn btn-outline btn-sm btn-pill">Follow @cavero.studio</a></div>
        </div>
      </section>
      <Newsletter />
      <Footer />

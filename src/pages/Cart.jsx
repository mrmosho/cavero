        ...
        <div className="container">
          ...
          {cart.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '80px 24px' }} className="reveal">
              <div style={{ fontFamily: 'var(--font-display)', fontSize: '2rem', fontWeight: 300, marginBottom: 16 }}>
                Your cart is empty
              </div>
              <p style={{ color: 'var(--stone)', marginBottom: 32 }}>
                Nothing here yet — browse the collection.
              </p>
            ...
            <div className="cart-grid reveal">
                  ...
                  <div className="cart-item" key={item.key}>
                    ...
                    <div>
                      ...
                      <div className="cart-item__variant">
                        {item.variantName && `${item.variantName} · `}{item.label}
                      </div>
                      {item.personalisationNote && (
                        <div style={{ fontSize: '0.78rem', color: 'var(--stone)', marginBottom: 8 }}>
                          Note: {item.personalisationNote}
                        </div>
                      )}
                      ...
                      <div className="cart-item__remove" onClick={() => removeFromCart(item.key)}>
                        Remove
                      </div>
                    </div>

                    <div style={{ textAlign: 'right' }}>
                      <div style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', fontWeight: 500, color: 'var(--bronze)' }}>
                        EGP {(item.price * item.qty).toLocaleString()}
                      </div>
                      <div style={{ fontSize: '.78rem', color: 'var(--stone)', marginTop: 4 }}>
              ...
              <div className="cart-summary">
                ...
                <Link to="/checkout" className="btn btn-bronze btn-full" style={{ marginTop: 24 }}>
                  Proceed to Checkout
                </Link>

                <p className="cart-summary__notice" style={{ marginTop: 12 }}>

    ...
    <>
      ...
      <div style={{ paddingTop: 'calc(var(--nav-h) + 80px)', paddingBottom: 80, minHeight: '100vh', background: 'var(--cream)' }}>
        <div className="container">
          ...
          <h1 className="t-h1 reveal d1" style={{ marginBottom: 8 }}>
            We'd love to hear<br />from you.
          </h1>
          <p className="t-body reveal d2" style={{ maxWidth: 500 }}>
            For custom orders, questions, or just to say hi — we respond within 24 hours.
          </p>
          ...
          <div className="contact-grid reveal d3" style={{ marginTop: 60 }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <input className="form-input" type="email" value={form.email} onChange={set('email')} placeholder="hello@example.com" required />
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <textarea className="form-textarea" value={form.message} onChange={set('message')} placeholder="Tell us what you have in mind…" required />
              </div>
            ...
            <div className="contact-info" style={{ paddingTop: 48 }}>
              {[
                { icon: '✉', label: 'Email',   value: 'hello@cavero.com' },
                { icon: '💬', label: 'WhatsApp', value: 'Available 10am – 8pm (Sun–Thu)' },
                { icon: '📍', label: 'Studio',   value: 'Cairo, Egypt' },
              ].map(info => (
                <div className="contact-info__item" key={info.label}>
                  <div className="contact-info__icon">{info.icon}</div>
                  <div>
                    <div className="contact-info__label">{info.label}</div>
                    <div className="contact-info__value">{info.value}</div>
                  </div>
                </div>
              ))}
              ...
              <div style={{ marginTop: 48, padding: 32, background: 'var(--charcoal)', borderRadius: 'var(--r)', color: 'var(--cream)' }}>
                ...
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.3rem', fontWeight: 400, marginBottom: 13, color: 'var(--cream)' }}>
                  Something totally one-of-a-kind?
                </h3>
                <p style={{ fontSize: '0.875rem', color: 'rgba(232,228,216,0.62)', lineHeight: 1.8, marginBottom: 22 }}>
                  Couple statues, corporate gifts, wedding favours — we work with you from scratch.
                  Reach out and we'll make it happen.
                </p>
                <button
                  className="btn btn-bronze btn-sm"
                  onClick={() => setForm(f => ({ ...f, subject: 'custom' }))}
                >
